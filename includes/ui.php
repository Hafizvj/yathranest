...
function yn_icon(string $name): string
{
    static $paths = [
        ...
        'upload' => '<path d="M12 16V5M8 8.5 12 4.5l4 4"/><path d="M5 14v3.5A2.5 2.5 0 0 0 7.5 20h9a2.5 2.5 0 0 0 2.5-2.5V14"/>',
        'image' => '<rect x="3.5" y="5" width="17" height="14" rx="2.5"/><circle cx="9" cy="10" r="1.6"/><path d="m5 17 4.2-4 3 2.6 2.6-2.6L19 17"/>',
        'file-text' => '<path d="M14 3.5H7.5A2 2 0 0 0 5.5 5.5v13a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2V8L14 3.5z"/><path d="M13.5 3.8V8h4.4M9 12.5h6M9 16h4"/>',
        'star' => '<path d="m12 4.2 2.4 4.9 5.4.8-3.9 3.8.9 5.4-4.8-2.6-4.8 2.6.9-5.4-3.9-3.8 5.4-.8L12 4.2z"/>',
        'list' => '<path d="M9 6.5h11M9 12h11M9 17.5h11M4.5 6.5h.01M4.5 12h.01M4.5 17.5h.01"/>',
        'plus' => '<path d="M12 5.5v13M5.5 12h13"/>',
        'trash' => '<path d="M5.5 7.5h13M9.5 7.5V5.8A1.3 1.3 0 0 1 10.8 4.5h2.4a1.3 1.3 0 0 1 1.3 1.3v1.7"/><path d="M7 7.5 7.8 19a1.5 1.5 0 0 0 1.5 1.4h5.4A1.5 1.5 0 0 0 16.2 19L17 7.5"/><path d="M10.5 11v6M13.5 11v6"/>',
